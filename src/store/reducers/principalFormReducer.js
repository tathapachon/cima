// principalFormReducer.js
import { createReducer } from '@reduxjs/toolkit';
import { addSection, updateSection, deleteSection } from '../../store/actions/principalFormActions.js';
...
const sectionReducer = createReducer(initialState, {
  ...
  [deleteSection]: (state, action) => {
    ...
    const updatedPrincipalForm = state.filter((section) => section.id !== sectionIdToDelete);

    return updatedPrincipalForm;
  },
});
